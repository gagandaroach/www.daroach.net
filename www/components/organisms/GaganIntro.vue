  ...
  <AtomCard>
    <div class="flex flex-col space-y-2">
      ...
      <AtomParagraph>
        ...
        <a href="https://youtu.be/J-GVd_HLlps?t=32" class="text-primary hover:text-primary/80">
      ...
      <div class="flex m-auto space-x-4">
        <MoleculeButton>Learn More</MoleculeButton>
        <MoleculeButton>Contact</MoleculeButton>
      </div>
    </div>
  </AtomCard>
</template> 